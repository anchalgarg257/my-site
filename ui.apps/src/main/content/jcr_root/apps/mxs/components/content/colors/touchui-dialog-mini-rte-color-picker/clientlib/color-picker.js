(function($, CUI){
    var GROUP = "experience-aem",
        ...
        REQUESTER = "requester",
        PICKER_URL = "/apps/mxs/components/content/colors/touchui-dialog-mini-rte-color-picker/color-picker-popover/cq:dialog.html";
    ...
    function addDialogTemplate(){ 
        ...
        var html = "<iframe width='400px' height='440px' frameBorder='0' src='" + url + "'></iframe>";
   ...
   function queryParameters() {
    ...
    function stylePopoverIframe(){
        ...
        var $addColor = $dialog.find(ADD_COLOR_BUT),
            ...
            $coralFormFieldWrapper = $document.find(".coral-Form-fieldwrapper");
        ...
        $coralFormFieldWrapper.css("width", "50px");
        $coralFormFieldWrapper.css("float", "left");
        $(ADD_COLOR_BUT).css("margin-left", "24px");
    ...
    function adjustHeader($dialog){
        var $header = $dialog.css("background-color", "#fff")
            .css("height", "430px").find(".coral3-Dialog-header");

        $header.css("margin-top", "-215px");
